...
import studio.lineage2.bugs.recaptcha.RecaptchaForm;
...
/**
 ...
 27.05.2016
 */
@Entity @Table(name = "master_account") public class MAccount implements UserDetails, RecaptchaForm
{
	...
	@NotEmpty(message = "Заполните поле") @Email(message = "Неверный Email") @Column(name = "username") private @Setter String username;
	...
	@Column(name = "admin") private @Getter @Setter boolean admin;
	@Transient private String recaptchaResponse;
